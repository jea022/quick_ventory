...
const CrearEspacio = () => {
  ...
  const manejarCrear = async (e) => {
    ...
    try {
      ...
      setError('Hubo un error al crear el espacio. Por favor, inténtalo de nuevo.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-display font-bold text-white">Crear Espacio</h1>
          <p className="text-gray-400 mt-1">Agrega un nuevo espacio a tu inventario</p>
        </div>
      </div>

      {/* Form */}
      <div className="glass-card rounded-2xl p-8">
        <form onSubmit={manejarCrear} className="space-y-6">
          <div>
